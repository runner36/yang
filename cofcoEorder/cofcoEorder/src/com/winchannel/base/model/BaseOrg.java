...
public class BaseOrg implements java.io.Serializable {
	...
	//负责的所有地理区域名称
	private String geoAll;

	private Set baseEmployees = new HashSet(0);

	private Set baseDepts = new HashSet(0);
	...
	public Set getBaseDepts() {
		return this.baseDepts;
	}

	public void setBaseDepts(Set baseDepts) {
		this.baseDepts = baseDepts;
	}

	public Set getBaseOrgs() {
		return this.baseOrgs;
	}
	...
	public String getGeoAll() {
		return geoAll;
	}
	public void setGeoAll(String geoAll) {
		this.geoAll = geoAll;
	}

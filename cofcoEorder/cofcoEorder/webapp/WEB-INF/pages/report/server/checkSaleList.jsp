...
<%@ include file="/commons/taglibs.jsp"%>
	...
	<tr>
		...
		<td>
			<html:text name="ec" property="createTime1" onfocus="WdatePicker()" readonly="true" styleClass="date_but"/>-<html:text name="ec" property="createTime2" onfocus="WdatePicker()" readonly="true" styleClass="date_but"/>
		</td>
	</tr>
	<tr>
		<td width="1%">
	...
	<tr>
		...
		<td width="1%">
			${mr['page.common.custStandardName']}
		</td>
		<td width="1%">
			<html:text name="ec" property="targetstoreName"/>
		</td>
		<td width="1%">
			${mr['page.common.custStandardCode']}
		</td>
		<td>
			<html:text name="ec" property="targetStoreCode"/>
		</td>
	</tr>

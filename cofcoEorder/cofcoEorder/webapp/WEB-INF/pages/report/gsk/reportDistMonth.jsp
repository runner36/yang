...
<%@ include file="/commons/taglibs.jsp"%>
	...
	<tr>
		...
		<td width="1%" align="left"><html:text name="ec" property="queryDate" maxlength="20" styleClass="date_but" onclick="showYear(this)" readonly="true"/></td>
		<td width="1%" align="right">${mr['page.common.orgName']}</td>
		...
		<td width="1%" align="right">${mr['page.common.geographicArea']}</td>
		<td width="1%" align="left">

...
<tr>
    <td >Date：</td>
	<td >
	   <html:text name="ec" property="yyyyMm" maxlength="7" styleClass="date_but" onclick="showTable(this)" readonly="true"/>
	 </td>
	 <td >City：</td>
	 <td >
	 ...
	 <td ><html:hidden name="ec" property="bannerIds" />
		<html:text name="ec" property="bannerNames" maxlength="20" styleClass="select_but" onclick="selectBannerIds()" readonly="true" />
	 </td>
	 <td><br/></td>
</tr>
<script type="text/javascript">

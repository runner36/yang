...
<script>
	...
	function selectBrand() {
		...
		var v=  window.showModalDialog('${ctx}' + "/tree/tmpSourceData.do?method=brandDictTree&title=" + encodeURI("Brand") + "&state=1&first=1&onlyLeaf=2&checkbox=2&values=" + form.brandId.value + "&rand=" + Math.random(), "", "dialogHeight:420px;dialogWidth:420px;scroll=no;help:no;status:no");
		if (v) {
...
<tr>
	...
	<td> 
		<html:select name="ec" property="Unit">   
			<html:option value="291">Qli（100公斤）</html:option> 
         </html:select>   	 
	</td>

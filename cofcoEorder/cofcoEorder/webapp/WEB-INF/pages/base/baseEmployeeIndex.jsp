	...
	<body onLoad="WindowSollAuto()" onResize="WindowSollAuto()">
		<div class="bosom_one">
			<div class="bosom_top">
				...
				<div class='MenuList'>
					<!--MenuStrat
					<a href="javascript:content.confirmOrg();" class="Im80">${mr['page.common.button.confirmOrg']}</a>-->
							...
							<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
								<tr>
									<td style="display:table-cell !important; display:block" width="220" height="100%" valign="top" id="leftmenu1" style="display:block">
										<iframe src="${ctx}/tree/baseTree.do?method=empTree&first=1&target=content&action=${ctx}/base/baseEmployee.do?method=edit" name="tree" width="220" marginwidth="0" height="100%" style="height:100%"
											marginheight="0" align="top" scrolling="auto" frameborder="0"></iframe>
									</td>
									<td height="100%" align="left" valign="top">
										<iframe src="baseEmployee.do?method=add" name="content" width="100%" marginwidth="0" height="100%"
											marginheight="0" align="top" scrolling="auto" frameborder="0"></iframe>
									</td>
								</tr>
							</table>

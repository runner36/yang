...
<html>
	<head>
		<title>${mr['page.customize.title.custMappingImport']}</title>
	...
	<jsp:include page="/commons/messages.jsp" flush="true"></jsp:include>
		<form name="impForm" action="${ctx}/server/dmsStoreMapping.do?method=imp&save=1" method="post" enctype="multipart/form-data">
			<div class="bosom_one">
				<div class="bosom_top">
					<span class="left"></span>
					<h4>
						${mr['page.customize.title.custMappingImport']}
					</h4>
					<div class='MenuList'>
						<a href="javascript:save();">${mr['page.common.button.save']}</a>
						<a href="${ctx}/excel/门店匹配导入模板.xls">${mr['page.common.button.template']}</a>
						<a href="dmsStoreMapping.do?method=list">${mr['page.common.button.return']}</a>
					</div>
							...
							<div class="sheet_div">
								<table class="list_add">
									...
									<tr id="mess" style="display:none">
										<td class="formTable" colspan="2"><br><br><br><br>${mr['page.common.mess.wait']}......</td>
									</tr>
									<tr>

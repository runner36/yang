...
<html>
	<head>
		...
		<title>${mr['page.customize.title.dmsDataStock']}</title>
	    ...
	    function query() {
			resetec();
			var form = document.dmsDataStockForm;
			form.$eq_state.disabled=false;
			if (checkCondition('${mr['page.common.queryCondition']}','${mr['page.common.mustChooseCondition']}','${mr['page.common.inventoryDate']}|$ge_stockDate,$le_stockDate#${mr['page.common.updatedTime']}|$ge_updateTime,$le_updateTime#${mr['page.common.deleteTime']}|$ge_deleteTime,$le_deleteTime#${mr['page.common.selectDefectiveData']}|$nl_deleteTime')==false){
				return;
			}
			loading();
			form.submit();
	...
	<body onload="WindowSollAuto();disabledInit();"><jsp:include page="/commons/messages.jsp" flush="true"></jsp:include>
		<html:form action="/server/dmsDataStock.do?method=list" method="post">
			<div class="bosom_one">
				<div class="bosom_top">
					<span class="left"></span>
					<h4>
						<!--TitleStrat-->
						${mr['page.customize.title.dmsDataStock']}
						<!--TitleStrat-->
					</h4>
					<div class='MenuList'>
						<!--MenuStrat-->
						...
						<a href="javascript:dmsDataStockForm.ec_p.value=1;query()" id="query_A">${mr['page.common.button.query']}</a>
							...
							<div class="sheet_div">
								...
								<table>
									<tr>
										...
										<td width="1%">
											${mr['page.common.inventoryDate']}
										</td>
										<td>
											<html:text name="ec" property="$ge_stockDate" onfocus="WdatePicker()" readonly="true" styleClass="date_but"/>-<html:text name="ec" property="$le_stockDate" onfocus="WdatePicker()" readonly="true" styleClass="date_but"/>
										</td>
									</tr>
									<tr>
										<td width="1%">
									...
									<tr>
										...
										<td width="1%">
											<html:select name="ec" property="$eq_state" style="width: 105px">
									...
									<tr>
										...
										<td width="1%" colspan="7">
											<html:text name="ec" property="$lk_stockType"/>
										</td>
									</tr>
								</table>
								</div>
								<ec:table items="list" var="item" onInvokeAction="query()"
										form="dmsDataStockForm" retrieveRowsCallback="limit"
										style="width:100%" tableId="ec"
										action="dmsDataStock.do?method=list">
									<ec:exportXls fileName="${mr['page.customize.title.dmsDataStock']}.xls" tooltip="${mr['page.common.exportExcel']}" view="xls" />
									<ec:exportCsv fileName="${mr['page.customize.title.dmsDataStock']}.csv" tooltip="${mr['page.common.exportCVS']}" view="csv" />
									<ec:row highlightRow="true">
										...
										<ec:column property="stockDate" title="${mr['page.common.inventoryDate']}" cell="date" format="yyyy-MM-dd"/>
										<ec:column property="prodCode" title="${mr['page.common.distProdCode']}" />
										<ec:column property="stockType" title="${mr['page.common.stockLocation']}" />

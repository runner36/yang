...
<html>
	<head>
		...
		<title>${mr['page.customize.title.dmsDataInout']}</title>
	    ...
	    function query() {
			resetec();
			var form = document.dmsDataInoutForm;
			//reg = /^[-\+]?\d+(\.\d+)?$/;
	...
	<body onload="WindowSollAuto();disabledInit();"><jsp:include page="/commons/messages.jsp" flush="true"></jsp:include>
		<html:form action="/server/dmsDataInout.do?method=list" method="post">
			<div class="bosom_one">
				<div class="bosom_top">
					<span class="left"></span>
					<h4>
						<!--TitleStrat-->
						${mr['page.customize.title.dmsDataInout']}
						<!--TitleStrat-->
					</h4>
					<div class='MenuList'>
						<!--MenuStrat-->
						...
						<a href="javascript:dmsDataInoutForm.ec_p.value=1;query()" id="query_A">${mr['page.common.button.query']}</a>
							...
							<div class="sheet_div">
								...
								<table>
									...
									<tr>
										...
										<td width="1%">
											<%-- <html:text name="ec" property="$lk_prodNameCode"/> --%>
										</td>
										<td width="1%">
											<%-- ${mr['page.common.pordStandardCode']} --%>
										</td>
										<td width="1%">
											<%-- <html:text name="ec" property="$lk_targetProdCode"/> --%>
										</td>
										<td width="1%">
								...
								<ec:table items="list" var="item" onInvokeAction="query()"
										form="dmsDataInoutForm" retrieveRowsCallback="limit"
										style="width:100%" tableId="ec"
										action="dmsDataInout.do?method=list">
									<ec:exportXls fileName="${mr['page.customize.title.dmsDataInout']}.xls" tooltip="${mr['page.common.exportExcel']}" view="xls" />
									<ec:exportCsv fileName="${mr['page.customize.title.dmsDataInout']}.csv" tooltip="${mr['page.common.exportCVS']}" view="csv" />

...
<html>
	<head>
		<title>${mr['page.customize.title.unitRelationShipImport']}</title>
	...
	<body onLoad="WindowSollAuto()" onResize="WindowSollAuto()">
		...
		<div class="bosom_one">
			<div class="bosom_top">
				...
				<h4>
					<!--PageTitleStrat-->
					${mr['page.customize.title.unitRelationShipImport']}
					<!--PageTitleEnd-->
				</h4>
               <div class='MenuList'>
                    <a class="Im80" href="${ctx}/mdm/mdmConversion.do?method=downConv">${mr['page.common.templateDownload']}</a>
                    <a href="javascript:save();">${mr['page.common.button.import']}</a>
                    <a href="${ctx}/mdm/mdmConversion.do?method=convList">${mr['page.common.button.cancel']}</a>
               </div>
			...
			<div class="bosom_side">
				<div class="casing">
					...
					<div class="viscera" id="SollAuto">
						<div class="sheet_div">
	                      <form name="impForm" id="impForm" action="${ctx}/mdm/mdmConversion.do?method=saveConv" method="post" enctype="multipart/form-data">

...
<html>
	<head>
	    ...
	    function query() {
			resetec();
			var form = document.salesmanOrderForm;
			loading();
			form.submit();
		}
		//客户
		 function selectDist() {
			var form = document.salesmanOrderForm;
			var v = openDistTreeForOrder('${ctx}', '', '1', form.inDistId_.value,'SR');
			if (v) {
		...
		function selectOrg() {
			var form = document.salesmanOrderForm;
			var v = openOrgTreeForEorder('${ctx}','','','','SR');
			if (v) {
				if(v.id){
	...
	<body onload="WindowSollAuto()" onresize="WindowSollAuto()"><jsp:include page="/commons/messages.jsp" flush="true"></jsp:include>
		...
		<html:form action="/order/salesmanOrder.do?method=list" method="post">
			<div class="bosom_one">
				<div class="bosom_top">
					...
					<div class='MenuList'>
						...
						<a href="javascript:salesmanOrderForm.ec_p.value=1;query()" id="query_A">${mr['page.common.button.query']}</a>
						...
						<div class="viscera" id="SollAuto">
							<div class="sheet_div">
								...
								<table>
									...
									<tr>
											...
											<td ><html:hidden property="geoCode_"/>
												<html:hidden property="geoId_"/><html:text property="geoName" readonly="true" styleClass="select_but" onclick="selectDict('geography',salesmanOrderForm.geoId_,salesmanOrderForm.geoName)"/>
											</td>
											<td width="1%">组&nbsp;&nbsp;&nbsp;&nbsp;织</td>
								...
								<ec:table items="list" var="item" onInvokeAction="query()"
									form="salesmanOrderForm" retrieveRowsCallback="limit"
									style="width:100%" tableId="ec" sortRowsCallback="limit"
									action="salesmanOrder.do?method=list">
									...
									<ec:row highlightRow="true" >
										<ec:column property="null" width="1%" title="${mr['page.common.button.oper']}" sortable="false" viewsDenied="xls,csv">
											<center>
												...
												<html:link page="/order/salesmanOrder.do?method=edit&orderId=${item[0]}">

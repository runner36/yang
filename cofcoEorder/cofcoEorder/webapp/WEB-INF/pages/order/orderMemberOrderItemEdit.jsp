...
<html>
	...
	<script language="javascript">
		...
		function save() {			
			...
			var target = document.getElementById("orderMemberOrderItemForm");
	...
	<body onLoad="WindowSollAuto();sumTotal();" onResize="WindowSollAuto()">
		...
		<html:form styleId="orderMemberOrderItemForm" action="/order/orderMemberOrderItem.do?method=save" method="post">

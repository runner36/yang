...
<html>
	...
	<body onload="WindowSollAuto()" onresize="WindowSollAuto()">
		...
		<html:form action="/order/orderSap.do?method=salesmanList" method="post">
			<div class="bosom_one">
				<div class="bosom_top">
					...
					<div class="casing">
						...
						<div class="viscera" id="SollAuto">
							...
							<ec:table items="list" var="item" onInvokeAction="query()"
									...
									action="orderSap.do?method=salesmanList">
									<ec:exportXls fileName="SAP订单（业代）列表.xls" tooltip="导出EXCEL" view="xls" />
									<ec:exportCsv fileName="SAP订单（业代）列表.csv" tooltip="导出CSV" view="csv" />

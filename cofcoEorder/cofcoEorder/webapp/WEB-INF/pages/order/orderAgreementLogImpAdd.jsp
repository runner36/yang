...
<html>
	...
	<jsp:include page="/commons/messages.jsp" flush="true"></jsp:include>
		<form name="impForm" action="${ctx}/order/orderAgreementLog.do?method=saveimpAdd" method="post" enctype="multipart/form-data">
			<div class="bosom_one">
				<div class="bosom_top">
					...
					<div class='MenuList'>
						...
						<a href="${ctx}/order/orderAgreementLog.do?method=downStoreImpAdd">下载</a>
					</div>

...
<html>
	...
	<jsp:include page="/commons/messages.jsp" flush="true"></jsp:include>
		<form name="impForm" action="${ctx}/order/orderSap.do?method=saveimpAdd" method="post" enctype="multipart/form-data">
			<div class="bosom_one">
				<div class="bosom_top">
					...
					<div class='MenuList'>
						...
						<a id="ImExcel" href="${ctx}/order/orderSap.do?method=downStoreImpAdd">模板下载</a>
						<a href="${ctx}/order/orderSap.do?method=list">返回</a>
					</div>
